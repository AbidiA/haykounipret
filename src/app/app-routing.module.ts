...
import { AfficherComponent } from './DemoPages/fiche/afficher/afficher/afficher.component';
import { ProspetComponent } from './DemoPages/fiche/prospet/prospet/prospet.component';
import { QualificationComponent } from './DemoPages/fiche/qualification/qualification/qualification.component';
import { AnalyseComponent } from './DemoPages/fiche/analyse/analyse/analyse.component';
import { EditComponent } from './DemoPages/fiche/edit/edit/edit.component';
import { EditprospComponent } from './DemoPages/fiche/editprosp/editprosp/editprosp.component';
import { EditqualificationComponent } from './DemoPages/fiche/editqualification/editqualification/editqualification.component';
import { EditanalyseComponent } from './DemoPages/fiche/editanalyse/editanalyse/editanalyse.component';
import { AddComponent } from './DemoPages/simulateur/add/add/add.component';
import { ParamDisplayComponent } from './DemoPages/parametre/param-display/param-display.component';
import { DisplayComponent } from './DemoPages/simulateur/display/display/display.component';
import { ProfileComponent } from './DemoPages/profile/profile.component';
import { UserBoxComponent } from './Layout/Components/header/elements/user-box/user-box.component';
import { ListUsersComponent } from './DemoPages/users/list-users/list-users.component';
import { EditUsersComponent } from './DemoPages/users/edit-users/edit-users.component';
import { AfficherprofileComponent } from './DemoPages/profile/afficherprofile/afficherprofile.component';
import { ListEquipeComponent } from './DemoPages/equipe/list-equipe/list-equipe.component';
import { EditEquipeComponent } from './DemoPages/equipe/edit-equipe/edit-equipe.component';
import { AddEquipeComponent } from './DemoPages/equipe/add-equipe/add-equipe.component';
import { ModifierequipeComponent } from './DemoPages/equipe/modifierequipe/modifierequipe.component';
import { EditionComponent } from './DemoPages/simulateur/edition/edition.component';
import { EditsimComponent } from './DemoPages/fiche/editsim/editsim.component';
...
const routes: Routes = [
...

  {
    ...
    children: [
      ...
      {
        path : 'simulateur',
        component : AddComponent, data: {extraParameter: 'dashboardsMenu'}
      },
     {
       path : 'users/listUsers',
       component : ListUsersComponent ,  data: {extraParameter: 'dashboardsMenu'}
     },
     {
      path : 'users/editUsers',
      component : EditUsersComponent ,  data: {extraParameter: 'dashboardsMenu'}
    },
      {
        path : 'displayParam',
        component : ParamDisplayComponent, data: {extraParameter: 'dashboardsMenu'}
      },
      {
        path : 'edition',
        component : EditionComponent, data: {extraParameter: 'dashboardsMenu'}
      },
      {
        path : 'simulateur1',
        component : DisplayComponent, data: {extraParameter: 'dashboardsMenu'}
      }
      ,
      {
        path : 'editSimu',
        component : EditsimComponent ,  data: {extraParameter: 'dashboardsMenu'}
      },
  {
    path : 'ficheProspet',
    component : ProspetComponent, data: {extraParameter: 'dashboardsMenu'}
  },
  
  {
    path : 'ficheQuali',
    component : QualificationComponent, data: {extraParameter: 'dashboardsMenu'}
  },
  {
    path : 'ficheAna',
    component : AnalyseComponent, data: {extraParameter: 'dashboardsMenu'}
  }
  ,
  {
    path : 'listFiche',
    component : AfficherComponent , data: {extraParameter: 'dashboardsMenu'}
  },
  {
    path : 'edit',
    component : EditComponent, data: {extraParameter: 'dashboardsMenu'}
  }
  ,
  {
    path : 'equipe/list',
    component : ListEquipeComponent ,  data: {extraParameter: 'dashboardsMenu'}
  },
  {
    path : 'equipe/add',
    component : AddEquipeComponent ,  data: {extraParameter: 'dashboardsMenu'}
  },
  {
    path : 'equipe/edit',
    component : EditEquipeComponent , data: {extraParameter: 'dashboardsMenu'}
  },
  {
    path : 'equipe/edit/add',
    component : ModifierequipeComponent , data: {extraParameter: 'dashboardsMenu'}
  },
  {
    path:'editProspet',
    component : EditprospComponent, data: {extraParameter: 'dashboardsMenu'}
  },

  {
    path : 'editProfile',
    component : ProfileComponent, data: {extraParameter: 'dashboardsMenu'}
  }
  ,
  {
    path : 'profile',
    component : AfficherprofileComponent, data: {extraParameter: 'dashboardsMenu'}
  }
  ,
  {
    path:'editQuali',
    component : EditqualificationComponent, data: {extraParameter: 'dashboardsMenu'}
  },
  {
    path:'editAnalyse',
    component : EditanalyseComponent, data: {extraParameter: 'dashboardsMenu'}
  },
